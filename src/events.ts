...
export type AiosEvent =
  ...
  | { type: "chat.out"; channel: string; chatId: string; text: string; attachments?: Array<{ token: string; name: string; mime: string; caption?: string; kind?: "voice" }>; pushed?: boolean }
