...
const CONFIG_GROUPS: Record<string, string[]> = {
  Channels: ["TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USER_IDS", "AIOS_PRIMARY_CHAT", "SLACK_BOT_TOKEN", "SLACK_APP_TOKEN", "AIOS_CHAT_BINDINGS"],
  Media: ["GEMINI_API_KEY", "AIOS_GEMINI_IMAGE_MODEL"],
  ...
  Security: ["AIOS_UI_TOKEN", "AIOS_FULL_AUTONOMY"],
};
